...
public class UploadSave extends HttpServletRequestWrapper {
	 ...
	 */
	public UploadSave(HttpServletRequest request) throws FileUploadException {
	...
	public static UploadSave getFrom(HttpServletRequest request) {
		return (UploadSave) request.getAttribute(UploadSave.class.getName());
	}
